...
class WebUtils{
  ...
  static List<ProjectModel> projects = [
    ...
    ProjectModel(
      title: "CVNext",
      description:
      "An AI-powered career platform that helps users create professional resumes and cover letters, prepare for interviews, and check ATS compatibility with smart AI integration.",
      imageUrl:
